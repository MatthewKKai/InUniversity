# -*- coding: utf-8 -*-
"""
Created on Wed Nov 21 14:47:14 2018
@author: Matthew Kai
"""
...
#根据原js文件求得salt
def getSalt():
    # time.time()单位为s ,js的(new Date).getTime() 单位毫秒，要进行转换
...
# 获取sign
# 原js文件中存在的 o = n.md5("fanyideskweb" + t + i + "ebSeFb%=XZ%T[KZ)c(sy!");
def getSign(v, salt):
...
def getPost(value):
    ...
    # 参数data需要是bytes格式 需要用parse进行code
